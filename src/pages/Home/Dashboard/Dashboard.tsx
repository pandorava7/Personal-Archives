          ...
          <div className='personal-area'>
            <div className='brand'>
              <div className='title-1-bg'>
                <p className='title-1'>{t("brand.title1")}</p>
              </div>
              <p className='title-2'>{t("brand.title2")}</p>
              <p className='title-3 text-shadow'>{t("brand.title3")}</p>
              ...
              <div className='h-full flex flex-col justify-between w-full pr-5'>
                ...
                <div className='flex justify-end gap-5'>
                  <div className='scroll-button relative button rd-infinity flex flex-row justify-end overflow-hidden w-auto'
                    ...
                    <p className='absolute right-15'>{t("common.profession")}</p>
